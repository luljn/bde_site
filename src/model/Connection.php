<?php
    ...
    namespace src\model\Connection;
    ...
    require_once('C:/Users/User/Documents/X2026/X2 2022-2023/SEM2 X2/3 - Développement Web/Projet Web/bde_site/src/controllers/Homepage.php');
    use src\controllers\Homepage\HomepageController;

    class Connection{

        /*
            This function allow to a user to connect himself on the site.
            If he has an account.
        */
        public function getConnection($email, $password){
            ...
            $statement_2 = "SELECT password AS password from users WHERE email = '{$email}';";
            ...
            if($resultat_1['email'] === 1 and password_verify($password, $resultat_2['password'])){

                //header('location: http://localhost:4000/index.php?action=homepage');

...
<html lang="en">
    ...
    <header class="header" id="header">
      ...
      <div class="top-nav">
        <div class="container d-flex">
          <p>Order Online Or Call Us: (237) 671109758</p>
          <ul class="d-flex">
            ...
            <li class="glide__slide">
              <div class="center">
                <div class="left">
                  ...
                  <h1 class="">WELCOME TO OUR BDE SHOP</h1>
                  <p>Trending from men's and women's  style collection</p>
                  <a href="#" class="hero-btn">SHOP NOW</a>
                </div>
                <div class="right">
                    <!--img class="img1" src="images_1/hero-1.png" alt=""-->
                </div>
              </div>
            </li>
            <li class="glide__slide">
              <div class="center">
                ...
                <div class="right">
                  <img class="img2" src="images_1/hero-2.png" alt="">
                </div>
              </div>
            </li>
          </ul>
    ...
    <section class="section category">
      <div class="cat-center">
        <div class="cat">
          <img src="images_1/cat3.jpg" alt="" />
          <div>
            <p>WOMEN'S WEAR</p>
          </div>
        </div>
        <div class="cat">
          <img src="images_1/cat2.jpg" alt="" />
          <div>
            <p>ACCESSORIES</p>
          </div>
        </div>
        <div class="cat">
          <img src="images_1/cat1.jpg" alt="" />
          <div>
            <p>MEN'S WEAR</p>
          </div>
        </div>
    ...
    <section class="section new-arrival">
      ...
      <div class="product-center">
        <div class="product-item">
          <div class="overlay">
            <a href="productDetails.html" class="product-thumb">
              <img src="images_1/product-1.jpg" alt="" />
            </a>
          </div>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="images_1/product-3.jpg" alt="" />
            </a>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="images_1/product-2.jpg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>MEN'S CLOTHES</span>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="images_1/product-4.jpg" alt="" />
            </a>
            <span class="discount">50%</span>
          </div>
          <div class="product-info">
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="images_1/product-5.jpg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>MEN'S CLOTHES</span>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="images_1/product-6.jpg" alt="" />
            </a>
          </div>
          <div class="product-info">
            <span>MEN'S CLOTHES</span>
        ...
        <div class="product-item">
          <div class="overlay">
            <a href="" class="product-thumb">
              <img src="images_1/product-7.jpg" alt="" />
            </a>
            <span class="discount">50%</span>
          </div>
          <div class="product-info">
...
<div class="right">
  <img src="images_1/banner.png" alt="">
</div>
    </section>
  ...
  <script src="dynamic/index.js"></script>
	</body>
</html>